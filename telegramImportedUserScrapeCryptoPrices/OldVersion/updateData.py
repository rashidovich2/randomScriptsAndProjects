...
while 1<2:
  ...
  for section in config.sections():
    ...
    try: 
      print(f'https://charts.bogged.finance/?token={address}')
      driver.get(f'https://charts.bogged.finance/?token={address}')
      ...
      string = f'Market Cap= {marketcap}   Price = {price}   Index = {index}'
      print(string)
